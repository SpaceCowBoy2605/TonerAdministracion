...
def api_get_all_plantas():
	...
	from app.crud.planta_crud import get_all_planta
...
def api_get_planta(id):
	...
	from app.crud.planta_crud import get_planta_by_id
...
def api_create_planta():
	...
	from app.crud.planta_crud import create_planta
...
def api_update_planta(id):
	...
	from app.crud.planta_crud import update_planta
	from flask import request
	data = request.get_json()
	if not data:
		return jsonify({"error": "Datos inválidos"}), 400
...
def api_delete_planta(id):
	...
	from app.crud.planta_crud import delete_planta
